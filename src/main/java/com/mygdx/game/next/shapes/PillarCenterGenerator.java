...
public class PillarCenterGenerator {
  private static final float WIDTH = 1f / 3;
  private static final Matrix4 T =
      new Matrix4().scale(WIDTH, 1, WIDTH).translate(S - (WIDTH / 2), 0, S - (WIDTH / 2));

  public static Face leftFaceFull() {
    return new Face(
        new Vertex[] {
          new Vertex(
              BACK_TOP_LEFT.cpy().mul(T), NORMAL_LEFT.cpy(), new Vector2(0.5f - (WIDTH / 2), 0)),
          new Vertex(
              FRONT_TOP_LEFT.cpy().mul(T), NORMAL_LEFT.cpy(), new Vector2(0.5f + (WIDTH / 2), 0)),
          new Vertex(
              FRONT_BOTTOM_LEFT.cpy().mul(T),
              NORMAL_LEFT.cpy(),
              new Vector2(0.5f + (WIDTH / 2), 1)),
          new Vertex(
              BACK_BOTTOM_LEFT.cpy().mul(T), NORMAL_LEFT.cpy(), new Vector2(0.5f - (WIDTH / 2), 1)),
        },
  ...
  public static Face rightFaceFull() {
    return new Face(
        new Vertex[] {
          new Vertex(
              FRONT_TOP_RIGHT.cpy().mul(T), NORMAL_RIGHT.cpy(), new Vector2(0.5f - (WIDTH / 2), 0)),
          new Vertex(
              BACK_TOP_RIGHT.cpy().mul(T), NORMAL_RIGHT.cpy(), new Vector2(0.5f + (WIDTH / 2), 0)),
          new Vertex(
              BACK_BOTTOM_RIGHT.cpy().mul(T),
              NORMAL_RIGHT.cpy(),
              new Vector2(0.5f + (WIDTH / 2), 1)),
          new Vertex(
              FRONT_BOTTOM_RIGHT.cpy().mul(T),
              NORMAL_RIGHT.cpy(),
              new Vector2(0.5f - (WIDTH / 2), 1)),
        },
        new short[] {0, 3, 1 /**/, 3, 2, 1});
  ...
  public static Face frontFaceFull() {
    return new Face(
        new Vertex[] {
          new Vertex(
              FRONT_TOP_LEFT.cpy().mul(T), NORMAL_FRONT.cpy(), new Vector2(0.5f - (WIDTH / 2), 0)),
          new Vertex(
              FRONT_TOP_RIGHT.cpy().mul(T), NORMAL_FRONT.cpy(), new Vector2(0.5f + (WIDTH / 2), 0)),
          new Vertex(
              FRONT_BOTTOM_RIGHT.cpy().mul(T),
              NORMAL_FRONT.cpy(),
              new Vector2(0.5f + (WIDTH / 2), 1)),
  ...
  public static Face backFaceFull() {
    return new Face(
        new Vertex[] {
          new Vertex(
              BACK_TOP_RIGHT.cpy().mul(T), NORMAL_BACK.cpy(), new Vector2(0.5f - (WIDTH / 2), 0)),
          new Vertex(
              BACK_TOP_LEFT.cpy().mul(T), NORMAL_BACK.cpy(), new Vector2(0.5f + (WIDTH / 2), 0)),
          new Vertex(
              BACK_BOTTOM_LEFT.cpy().mul(T), NORMAL_BACK.cpy(), new Vector2(0.5f + (WIDTH / 2), 1)),
          new Vertex(
              BACK_BOTTOM_RIGHT.cpy().mul(T),
              NORMAL_BACK.cpy(),
              new Vector2(0.5f - (WIDTH / 2), 1)),
  ...
  public static Face topFaceFull() {
    return new Face(
        new Vertex[] {
          new Vertex(
              BACK_TOP_LEFT.cpy().mul(T),
              NORMAL_TOP.cpy(),
              new Vector2(0.5f - (WIDTH / 2), 0.5f - (WIDTH / 2))),
          new Vertex(
              BACK_TOP_RIGHT.cpy().mul(T),
              NORMAL_TOP.cpy(),
              new Vector2(0.5f + (WIDTH / 2), 0.5f - (WIDTH / 2))),
          new Vertex(
              FRONT_TOP_RIGHT.cpy().mul(T),
              NORMAL_TOP.cpy(),
              new Vector2(0.5f + (WIDTH / 2), 0.5f + (WIDTH / 2))),
          new Vertex(
              FRONT_TOP_LEFT.cpy().mul(T),
              NORMAL_TOP.cpy(),
              new Vector2(0.5f - (WIDTH / 2), 0.5f + (WIDTH / 2))),
        },
        new short[] {0, 3, 1 /**/, 3, 2, 1});
